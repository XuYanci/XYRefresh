...
class XYCollectionNode2:ASCollectionNode,XYRefreshControlHeaderDelegate,XYRefreshControlFooterDelegate  {
    var header: XYHeaderRefreshControl2? {
        willSet {
    ...
    var footer: XYFooterRefreshControl2? {
        willSet {
    ...
    init(layout:UICollectionViewLayout?,header:XYHeaderRefreshControl2?,footer:XYFooterRefreshControl2?) {
